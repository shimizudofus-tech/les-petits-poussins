...
export default function BottomNav() {
  ...
  return (
    <nav className="bottom-nav flex w-full max-w-full shrink-0 items-stretch justify-around px-1 py-1.5">
      {NAV_ITEMS.map(({ screen, icon, label }) => (
        ...
        >
          <span className="bottom-nav-icon text-xl leading-none">{icon}</span>

...
export const moyenneLegacyPuzzleExercises = [
  {
...
export const moyenneProceduralPuzzleExercises = buildProceduralPuzzleExercises('moyenne')

export const moyennePuzzleExercises = moyenneProceduralPuzzleExercises
